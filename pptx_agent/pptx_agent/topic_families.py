...
_PITCH_DECK = TopicFamily(
    ...
    checklist=[
        SlideRole("cover", "cover", "{topic}",
                  theme_keywords=[], eyebrow="Investor Pitch", min_claims=0, max_claims=0),
        SlideRole("agenda", "roadmap", "What we will cover",
                  theme_keywords=[], eyebrow="Agenda", min_claims=0, max_claims=0, required=False),
...
_RESEARCH_BRIEFING = TopicFamily(
    ...
    checklist=[
        SlideRole("cover", "cover", "{topic}",
                  theme_keywords=[], eyebrow="Research Briefing", min_claims=0, max_claims=0),
        SlideRole("agenda", "roadmap", "Briefing agenda",
                  theme_keywords=[], eyebrow="Agenda", min_claims=0, max_claims=0, required=False),
...
_MARKET_ANALYSIS = TopicFamily(
    ...
    checklist=[
        SlideRole("cover", "cover", "{topic} — Market Analysis",
                  theme_keywords=[], eyebrow="Market Analysis", min_claims=0, max_claims=0),
        SlideRole("agenda", "roadmap", "What this analysis covers",
                  theme_keywords=[], eyebrow="Agenda", min_claims=0, max_claims=0, required=False),
...
_CASE_STUDY = TopicFamily(
    ...
    checklist=[
        SlideRole("cover", "cover", "{topic}",
                  theme_keywords=[], eyebrow="Case Study", min_claims=0, max_claims=0),
        SlideRole("agenda", "roadmap", "Case study at a glance",
                  theme_keywords=[], eyebrow="Agenda", min_claims=0, max_claims=0, required=False),
...
_PRODUCT_OVERVIEW = TopicFamily(
    ...
    checklist=[
        SlideRole("cover", "cover", "{topic}",
                  theme_keywords=[], eyebrow="Product", min_claims=0, max_claims=0),
        SlideRole("agenda", "roadmap", "What you will see",
                  theme_keywords=[], eyebrow="Agenda", min_claims=0, max_claims=0, required=False),
